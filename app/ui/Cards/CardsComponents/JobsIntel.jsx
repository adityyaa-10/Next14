  ...
  return (
    <div className={`w-full ${isLoading ? "animate-pulse" : ""}`}>
      {isLoading ? (
        ...
        <div>
          <div className="mx-auto h-full w-full rounded-md border bg-white p-4 shadow-sm">
            <div className="mb-2">
              <p className="text-start text-lg font-semibold leading-7 tracking-normal text-gray-800">
                {title}
              </p>
            </div>
            <div className="mb-2">
              <p className="text-base font-medium tracking-normal text-blue-600">
                {author}
              </p>
            </div>
            ...
            <div>
              <div
                className="leading-7 tracking-normal text-[#0e0e0e]"
