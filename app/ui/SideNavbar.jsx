    ...
    return (
        <div>
            <Disclosure as="nav">
                ...
                <div className="p-6 w-1/2 h-screen bg-slate-100 z-20 fixed top-0 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
